  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(
      ...
      (
        ...
        state.loading = false
        if (action.payload) {
          state.user.courses.template_short_course =
            action.payload.courses?.template_short_course
          state.user.certificates.template_short_course =
            action.payload.certificates?.template_short_course
        }
      },
    )
