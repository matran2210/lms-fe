...
const TestDetail = () => {
  ...
  const handleClearSelection = async (currentTabContent: any) => {
    ...
    if (data && !currentTabContent.is_viewed_answer) {
      ...
      if (data.qType === QUESTION_TYPES.FILL_WORD) {
          ...
          >
                  ...
                  .then(() => {
                    if (type === 'entrance') {
                      ...
                      if (
                        ...
                        router.replace(
                          `/short-course/test/your-answers-detail/${QuizResultId}`,
                        )
                      } else {
                        router.replace(
            ...
            {openReportModal && openReportModal.open && (
              <SuccessSubmittedConstructorModal
                ...
                handleOk={() => {
                  router.replace(
                    `/short-course/test/your-answers-detail/${openReportModal.resultId}`,
                  )
                }}
              />
            )}
