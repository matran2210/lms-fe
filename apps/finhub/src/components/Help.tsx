        ...
        <div className="cursor-pointer">
          ...
          >
            {visible ? (
              ...
              >
                <div className="plus flex size-12 items-center justify-center rounded-full bg-white transition delay-300 hover:opacity-100">
                  <svg
                    width="48"
                    height="48"
                    viewBox="0 0 34 34"
              ...
              <Tooltip title={'Support Center'} placement="left">
                <div
                  id="floating-button"
                  onClick={handleButtonClick}
                  className={`${visible ? 'clicked' : ''} bottom-5 right-[16px]`}
                >
