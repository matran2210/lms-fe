...
import { download, runHighlight } from '@utils/index'
    ...
    <SappLoadingGlobal loading={loading}>
      ...
      >
        ...
        >
                ...
                >
                  ...
                  {topics?.description && (
                    ...
                    >
                      ...
                      {/* {topics?.description && (
                        <HighlightableHTML
                          initialHTML={topics?.description || ''}
                          storageKey={`${topics?.id}-question-topic-case-study`}
                        />
                      )} */}
                    </div>
                  )}
          ...
          <div className="absolute bottom-[80px] right-8 z-[1050] flex w-12 flex-col gap-2">
            {topics?.files?.length > 0 && (
              <Popover
                className=""
                placement="leftTop"
          ...
          {exhibitData && exhibitData?.length > 0 && (
            ...
            >
              <Popover
                ...
                placement="left"
              >
                <div className="group fixed bottom-[242px] right-8 z-[1000] grid h-12 w-12 cursor-pointer place-items-center rounded-full bg-primary hover:bg-blend-overlay">
