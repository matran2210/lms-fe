...
import Calendar from '../../../components/teacher/my-calendar/Calendar'
import EventDetails from '../../../components/teacher/my-calendar/EventDetails'
import NewEventSidebar from '../../../components/teacher/my-calendar/NewEventSidebar'
...
export default withAuthorization([UserType.TEACHER])(MyCalendarPage)
