...
import FormAddProgress from '../progress-form/FormAddProgress'
import FormViewProgress from '../progress-form/FormViewProgress'
...
const Progress = ({ classDetail }: { classDetail: IClassDetail }) => {
  ...
  const { params: progressParams, progressApi } = useFeature()
  ...
  const {
    ...
    queryFn: () =>
      progressApi!.getProgressList({
        ...
        params: { ...cleanedParams, class_id: progressParams?.id },
      }),
    params,
  })
