...
import { IScheduleRequestItem } from '@lms/core/types/teachers/request-schedule.interface'
import { IOpenReasonModal, statusColor, UpdateStatusParams } from './TableContainer'
...
const DetailRequestModal = ({
  ...
  const { teacherApi, query } = useFeature()
