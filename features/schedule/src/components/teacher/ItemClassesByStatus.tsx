...
import { convertHourToDayLeft, convertLocalTimeToUTC, truncateString } from '@lms/utils'
      ...
      <div className={`flex flex-col gap-6`}>
        ...
        <div className="progress h-8">
          <div className="info mb-2 flex items-center justify-between">
            <div className="text flex items-center">
              <Icon
                ...
                className={`relative ${enableCourse ? 'text-gray-800' : 'text-divider'
                  }`}
              />
              <p
                className={`text-sm font-medium ${enableCourse ? 'text-gray-800' : 'text-divider '
                  } ml-px pl-2`}
              >
          ...
          <div className="progressbar h-[6px] bg-gray-200">
            <div
              className={`progress-percentage ${enableCourse ? 'bg-primary' : 'bg-divider'
                } h-[6px]`}
