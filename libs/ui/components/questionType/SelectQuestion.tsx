...
const DROPDOWN_STYLES = {
  ...
  option:
    "px-3 py-2 cursor-pointer rounded hover:bg-gray-100 transition-colors duration-100 flex flex-col ",
...
const SelectWord = forwardRef(
  (
    ...
    const createDropdownHTML = (
      ...
      return `
        <span class="selected-text ${DROPDOWN_STYLES.selectedText} ${disabledClass}" data-component-id="${componentId.current}">
