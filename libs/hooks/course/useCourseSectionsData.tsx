...
import { useInitialSections } from './useInitialSections'
...
export const useCourseSectionsData = ({
  ...
  } = useInitialSections(api)
  const subsectionData = useSectionData(selected.section, 'CHAPTER', api)
  const unitData = useSectionData(selected.subsection, 'UNIT', api)
  const activityData = useSectionData(selected.subsection, 'ACTIVITY', api)
