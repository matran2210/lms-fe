...
import { IActivityAPI, IAuthAPI, IAuthManager, ICaseStudyAPI, IClassAPI, ICourseActivityAPI, ICoursesAPI, IEntranceTestAPI, IEventTestAPI, INotificationAPI, IQuestionAPI, IUploadAPI, MenuItem } from "@lms/core"
...
const FeatureContext = createContext<FeatureContextProps>({} as FeatureContextProps)
