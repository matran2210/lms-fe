...
const UnSubmitAnswerModal = ({
  ...
  return (
    ...
    >
      ...
      <div className="py-8 pt-10 text-center text-3xl font-semibold text-bw-13 md:text-4xl">
        Are You Sure?
      </div>
      <div className=" text-center">
        <span className="text-center text-medium-sm font-normal text-bw-13">
          Oops look like you&apos;ve got a few unfinished questions:&nbsp;
        </span>
        <span className="text-center text-medium-sm font-semibold text-primary">
