...
export default function SingleDialogLayout(props: LayoutProps): ReactElement {
  ...
  return (
    <>
      ...
      <div className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-white pt-12 after:absolute after:bottom-0 after:left-0 after:block after:h-[7px] after:w-full after:bg-primary xs:pt-20 md:pt-[5.563rem] lg:pb-[2rem] lg:pt-[1rem]">
        <section>
