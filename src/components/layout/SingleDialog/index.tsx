...
export default function SingleDialogLayout(props: LayoutProps): ReactElement {
  ...
  return (
    <div className="w-screen min-h-screen bg-white relative pt-[5.563rem] pb-[7.313rem] after:absolute after:bottom-0 after:left-0 after:block after:w-full after:h-[0.813rem] after:bg-primary">
