...
export default function SingleDialogLayout(props: LayoutProps): ReactElement {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden lg:pb-[2rem] md:pt-[5.563rem] xs:pt-20 lg:pt-[1rem] pt-12 after:absolute after:bottom-0 after:left-0 after:block after:w-full after:h-[7px] after:bg-primary">
