        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="absolute bottom-0 right-0 inline-flex flex-col items-center justify-center gap-[20px] rounded-[20px] bg-gray-800/80 px-6 py-5 backdrop-blur-[2px] transition duration-200 ease-in-out"
            >
