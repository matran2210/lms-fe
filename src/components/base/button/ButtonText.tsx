...
const ButtonText = ({
  ...
  let componentClass = `${className} text-center ${fullWidthClass} ${paddingVerticalClass} ${paddingHorizontalClass} mx-0 text-bw-1 ${textSizeClass} font-semibold underline cursor-pointer`
