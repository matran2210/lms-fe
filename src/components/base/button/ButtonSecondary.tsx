...
const ButtonSecondary = ({
  ...
  let componentClass = `${className} text-center ${fullWidthClass} ${paddingVerticalClass} ${paddingHorizontalClass} mx-0 text-bw-1 ${textSizeClass} font-semibold bg-gray-3 hover:bg-bw-1 hover:text-gray-3 cursor-pointer`
