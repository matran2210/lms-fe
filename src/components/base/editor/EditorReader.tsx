...
const EditorReader = ({
  ...
  /**
   * @description Handles the event when an image is clicked.
   * Sets the content type to 'IMG' and updates the source of the clicked image.
   * Typically used to open a modal or display the image in a larger view.
   *
  ...
  return (
    <>
      <div
        className={`mce-content-body editor-wrap ${className}`}
        id={id || ''}
                  ...
                  if (videoToken) {
                    ...
                    return (
                      <SAPPVideo
                        ...
                        pauseOnSeek={true}
                        thumbnail={{
                          '375x220': `${video_url}${videoToken}/thumbnails/thumbnail.jpg?time=1s&height=220`,
                          '1031x605': `${video_url}${videoToken}/thumbnails/thumbnail.jpg?time=1s&height=605`,
                        }}
                      />
                    )
                  }
                ...
                if (domNode.type === 'tag' && domNode.name === 'img') {
                  ...
                  return (
                    <img
                      ...
                      className={clsx(attribs.class, 'cursor-pointer')}
                      draggable={false} // 🚫 không cho kéo ảnh
                    />
                  )
                }
              },
