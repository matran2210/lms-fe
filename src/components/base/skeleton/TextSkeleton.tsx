          ...
          {mockData.map((_, index) => (
            ...
            >
              ...
              <div className="mt-5 flex items-center justify-between">
                <div className="me-3 h-6 w-20 rounded-full bg-[#e5e7eb] dark:bg-[#374151]"></div>
                <div className="flex">
                  <div className="me-3 h-6 w-16 rounded-full bg-[#e5e7eb] dark:bg-[#374151]"></div>
                  <div className="h-6 w-16 rounded-full bg-[#e5e7eb] dark:bg-[#374151]"></div>
                </div>
              </div>
