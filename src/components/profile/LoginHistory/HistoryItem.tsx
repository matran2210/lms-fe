...
const HistoryItem = ({ data }: any) => {
  ...
  return (
    <div className="sapp-hover-device-item gap-1 border-b border-gray-300 px-2 py-[6px] pb-2 hover:bg-gray-100 md:gap-4 md:rounded-md md:border-none md:p-2">
      ...
      <div className="flex items-center gap-2 text-xs text-secondary-100 md:text-sm">
        ...
        {data.location && (
          <div className="mx-1 h-[4px] w-[4px] rounded-full bg-secondary-100"></div>
        )}
