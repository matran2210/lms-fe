import { ArrowActionSearchIcon, HamburgerMenuLargeIcon } from '@assets/v2/icons'
import SearchForm from '@components/v2/mycourses/Search'
import PopupStep from '@components/v2/user-guide/PopupStep'
import React, { useEffect, useRef, useState } from 'react'
import { PageLink, UserGuide } from 'src/constants'
import { MY_COURSES } from 'src/constants/lang'
import { useAppSelector } from 'src/redux/hook'
import TourGuideStart from 'src/assets/v2/lotties/tour-guide-start.json'
