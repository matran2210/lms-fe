    ...
    >
      ...
      {makeDefaultDrawer?.status && (
        <SappDrawerV2
          ...
          classNameHeader={
            '!bg-white !text-gray-v2-800 md:!p-0 lg:!px-8 lg:!py-6'
          }
        ...
        >
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <div className="text-text-gray-v2-800 flex items-center justify-between">
              <span className="inline-block text-secondary-v2-DEFAULT md:w-[302px]">
                <div className="flex">
            ...
            {makeDefaultDrawer?.address && (
              <div className="text-text-gray-v2-800 mt-5">
                <span className="inline-block text-secondary-v2-DEFAULT md:w-[302px]">
                  {' '}
                  Address:{' '}
                </span>
          ...
          <div>
            <div className="flex items-center justify-between gap-4 md:justify-start">
              <span className="text-sm font-semibold text-gray-v2-800 md:text-base">
                Set as default:
              </span>
              <Switch
