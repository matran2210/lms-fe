...
import useDownloadImage from 'src/hooks/v2/useDownloadImage'
...
const Certificate = () => {
  ...
  const columns: TableProps<ICertificate>['columns'] = [
    ...
    },
    {
      ...
      align: 'center',
      render: (record) => (
        <div className="text-secondary-v2-DEFAULT">{record?.pass_point}%</div>
      ),
    },
    {
      ...
      align: 'center',
      render: (record) => (
        <div className="text-secondary-v2-DEFAULT">
      ...
      render: (record) => (
        <div className="flex items-center justify-center gap-1">
          ...
          >
            <Icon
              type="download"
              className="cursor-pointer text-secondary-v2-DEFAULT hover:text-primary"
            />
          </div>
  ...
  return (
    <div className="mb-6 mt-0 md:mb-0 md:mt-8 lg:mt-10">
      ...
      <div className="flex flex-col gap-4 md:gap-6 lg:hidden">
        <div className="hidden text-xl font-semibold text-secondary-v2-DEFAULT md:block">
          Certificate
        </div>
...
const InfoWrapper = ({
  ...
  return (
    <div className="flex items-center justify-between text-sm md:text-base">
      ...
      <div className="font-semibold text-gray-v2-800">{value}</div>
    </div>
  )
}
