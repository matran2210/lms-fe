...
import ButtonSecondary from '@components/v2/base/button/ButtonSecondary'
import TextSkeleton from '@components/base/skeleton/TextSkeleton'
import HookFormTextField from '@components/base/textfield/HookFormTextField'
import HookFormTextFieldV2 from '@components/v2/base/textfield/HookFormTextFieldV2'
            ...
            <ul>
              ...
              >
                {isEdit ? (
                  ...
                  <div className="flex flex-auto justify-end break-all text-end font-medium text-gray-v2-800 lg:max-w-[300px] lg:justify-start">
        ...
        >
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="rounded-lg bg-white p-4 shadow-small">
              <div className="mb-6 text-base font-semibold text-gray-v2-800">
                Edit Profile
              </div>
              <>
                <ul>
...
const TextWrapper = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={clsx(
          'max-w-[200px] flex-none text-gray-v2-800 md:w-[17.43rem] lg:max-w-[50%]',
      ...
      <div
        className={clsx(
          'flex flex-auto justify-end break-all text-end font-medium text-gray-v2-800 lg:max-w-[300px] lg:justify-start',
          {
