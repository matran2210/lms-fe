  ...
  return (
    <div className="p-6 lg:col-span-5 rounded-2xl">
      <div className="mb-5 flex flex-col pb-3">
        ...
        <div className="text-ink-400 4xl:text-sm">{`Last Update: ${dayjs().format(DATE_FORMAT.DATE_TIME_DASH)}`}</div>
      </div>
      <div className="flex flex-col p-4 bg-ink-100 rounded-lg">
        <div className="flex mb-2 flex-row items-center gap-4">
          ...
          <div className='text-lg font-semibold text-ink-800'>Activities Completed: {report?.activities?.current || 0}</div>
        </div>
        <div className='text-success text-base'>You've outperformed last week! Aim higher!</div>
      </div>

      <div className="mt-6 flex flex-col p-4 bg-ink-100 rounded-lg">
        <div className="flex mb-2 flex-row items-center gap-4 justify-between">
          <div className='flex'>
            ...
            <div className='text-lg font-semibold text-ink-800 items-center flex ms-4'>Learning Times: {report?.activities?.diff || 0}</div>
          </div>
        ...
        <div className='text-base text-ink-400'>From last week</div>
        </div>
      </div>
    </div>
  )
