    ...
    <div className="flex flex-col items-center justify-start gap-4 md:flex-row md:gap-6">
                  ...
                  <div className="flex h-full w-full items-center justify-center bg-black opacity-40">
                    {!loadingEditAvatar ? (
                      ...
                      <div role="status">
                        <svg
                          aria-hidden="true"
                          className="h-8 w-8 animate-spin fill-blue-600 text-[#DCDDDD] dark:text-[#4b5563]"
                          viewBox="0 0 100 101"
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
                        >
      ...
      <div className="w-full flex-1 md:my-6 lg:my-0">
        ...
        <div className="flex items-center justify-center gap-4 text-sm text-gray-400 md:justify-start md:gap-6">
          <div className="flex items-center justify-center gap-2 md:mb-0 md:justify-start">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="25"
              height="24"
