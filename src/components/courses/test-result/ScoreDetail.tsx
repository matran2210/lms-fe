...
import { ScoreDetailProps } from 'src/type/courses-3-level/test'
import { IAnswer, QuizAttemptChartType } from 'src/type'
                        ...
                        >
                          <div
                            ...
                            onClick={() => {
                              if (answer?.id) {
                                router.push(
                                  `/short-course/explanation/${answer?.id}?title=My Course`,
                                )
                              }
                            }}
                          />
