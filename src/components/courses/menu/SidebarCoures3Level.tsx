  ...
  return (
    <>
      ...
      <Sidebar3Level
        ...
        className={`menu-sidebar-left max-w-screen fixed top-4 m-4 hidden h-[calc(100vh-32px)] w-20 min-w-[80px] rounded-xl bg-white shadow-sidebar_menu md:left-0 md:block ${
