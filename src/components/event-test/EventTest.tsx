  ...
  return (
    <>
      ...
      <div>
        <div className="info">
          <div
            className={`border-gray-2 flex justify-between border-b pb-4 text-base capitalize ${getTextColor('text-gray-1')}`}
          >
            <p>
              {getEventTestStatus(
                'Time taken:',
        ...
        <div className="action relative mt-10 flex min-h-[32px] items-center justify-between">
          <div className="text flex items-center">
            ...
            />
            <p
              className={`text-medium-sm ml-px pl-2 font-medium ${getTextColor('text-bw-1')}`}
            >
      ...
      >
        <div className="text-medium-sm text-gray-1 mb-1 mt-4 text-center 2xl:mb-11">
          This Event Test{' '}
          {checkEventStatus(
            resultStartAt,
            resultFinishAt,
          ...
          on{' '}
          <span className="text-bw-1 font-semibold">
            {formatDate(
              new Date(
                resultStartAt === -1
                  ? data?.started_at
