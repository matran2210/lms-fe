...
const MultipleQuestion = ({ questions, className }: MultipleQuestionProps) => {
  ...
  return (
    <div
      className={`${className} fixed xl:static right-0 bottom-0 bg-white flex flex-col justify-between w-full max-w-[calc(100vw-80px)] xl:max-w-smd items-start px-6 py-4 xl:overflow-y-auto shadow-sidebar`}
    >
      <div
        className={`${
          showMore
