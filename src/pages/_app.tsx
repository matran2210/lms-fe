    ...
    <>
      <Head>
        ...
        <meta
          name="description"
          content={
            'Hệ thống Nền tảng Học và Thi trực tuyến được SAPP Academy xây dựng nhằm mục đích cung cấp trải nghiệm học tập hiện đại, cá nhân hóa, giúp học viên tối ưu kết quả học tập ACCA, CFA'
          }
          key="desc"
        />
        <meta
        ...
        <meta
          property="og:image"
          content={
            'https://s3-hn-2.cloud.cmctelecom.vn/lms-production/sapp_default_thumbnail.png'
          }
          key="image"
        />
